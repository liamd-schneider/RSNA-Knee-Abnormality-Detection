...
# This copy of extract.py is dedicated to the full run over the 4,349
# unlabeled studies -- kernels/extract_labels_v1 stays defaulted to
# "validate" as the safe default script.
MODE = os.environ.get("KNEE_MODE", "full")
