"""RSNA Knee Abnormality Detection -- baseline training kernel (v7, "moreepochs" variant).
...
LR_BACKBONE = 8e-6
LR_HEAD = 1e-3
RUN_NAME = "moreepochs"  # isolates "more epochs alone" -- v5's data volume, v6's epoch count
EPOCHS = int(os.environ.get("KNEE_EPOCHS", "15"))      # same as v6
VAL_FRAC = 0.2
SEED = 42
MAX_EXTRA = int(os.environ.get("KNEE_MAX_EXTRA", "1500"))  # unchanged from v5 on purpose
